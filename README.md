...
2. Ubuntu 22.04 LTS Clean Install
3. Post-Install Hardware Config
4. Security Hardening
5. Ollama + Local AI Setup
6. Obsidian Writing Environment
7. VirtualBox + Kali Security Lab
8. GitHub Documentation & Portfolio
