...
- Moved hardware documentation into [macbook-ubuntu-specs.md](macbook-ubuntu-specs.md).
...
System specifications for the original Ubuntu setup are documented in [macbook-ubuntu-specs.md](macbook-ubuntu-specs.md).
